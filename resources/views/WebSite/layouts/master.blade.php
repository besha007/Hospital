        ...
        <div class="header-upper">
            <div class="inner-container clearfix">
                ...
                <div class="logo-outer">
                    <div class="logo"><a href="{{ url('/') }}"><img src="{{URL::asset('WebSite/images/logo.png') }}" alt="" title=""></a></div>
                </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" class="img-responsive"><img src="images/logo2.png" alt="" title=""></a>
                </div>
