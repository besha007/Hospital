                           ...
                           aria-expanded="false">
                            @if (App::getLocale() == 'ar')
                                <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                        src="{{URL::asset('Dashboard/img/flags/sdn_flag.jpg')}}" alt="img"></span>
                                <strong
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('Dashboard/img/media/6.jpg') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('Dashboard/img/media/6.jpg') }}" class=""></div>
                        ...
                        @if (auth('web')->check())
                            ...
                            <form method="POST" action="{{ route('logout.ray_employee') }}">
                                ...
                                <form method="POST" action="{{ route('logout.laboratorie_employee') }}">
                                    ...
                                    <form method="POST" action="{{ route('logout.pharmacy') }}">
