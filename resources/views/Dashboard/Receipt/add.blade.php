...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{ route('Receipt.index') }}">{{ trans('main-sidebar_trans.Finance') }}</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة سند قبض جديد</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
