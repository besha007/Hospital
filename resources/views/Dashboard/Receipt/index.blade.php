                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($receipts as $receipt)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a href="{{route('Receipt.edit',$receipt->id)}}" class="btn btn-sm btn-success" title="تعديل"><i class="fas fa-edit"></i></a>
                                                       <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" href="#delete{{$receipt->id}}" title="حذف"><i class="las la-trash"></i></a>
