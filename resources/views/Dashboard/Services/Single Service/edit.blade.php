        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Service.update', 'test') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="name" id="name" value="{{$service->name}}" class="form-control"required ><br>

                    <input type="hidden" name="id" value="{{$service->id}}" class="form-control"><br>

                    <label for="price">{{trans('Services.price')}}</label>
                    <input type="number" name="price" id="price" value="{{$service->price}}" class="form-control" required><br>
