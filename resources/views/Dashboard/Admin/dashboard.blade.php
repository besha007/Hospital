...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ trans('home.c_panel') }}</h2>
						</div>
					</div>
					<div><p class="mg-b-0">{{ Auth()->user()->name }}</p></div>
					<div class="main-dashboard-header-right">
						
						<div>
							<label class="tx-13">{{ trans('main-sidebar_trans.Single_service') }}</label>
							
							<h5>{{ \App\Models\Service::count() }}</h5>
						</div>
						<div>
							<label class="tx-13">{{ trans('main-sidebar_trans.group_services') }}</label>
							{{-- <small class="text text-success">عدد الفواتير</small> --}}
