...
@include('Dashboard.messages_alert')
				...
				<div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('medicines.update', 'test') }}" method="post" autocomplete="off">
                                    {{ method_field('patch') }}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="inputName" name="name"
                                             value="{{ $medicines->name }}" title="يرجي ادخال اسم الدواء" required>
                                        </div>

                                        <div class="col">
                                            <label for="inputName" class="control-label">المجموعة</label>
                                            <input type="text" class="form-control" id="inputName" name="group"
                                            value="{{ $medicines->group }}" title="يرجي ادخال اسم المجموعة" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            value="{{ $medicines->company }}" title="يرجي ادخال اسم الشركة المصنعة" required>
                                        </div>
            
                                        <div class="col">
                                            <label for="inputName" class="control-label">التكلفة</label>
                                            <input type="number" class="form-control" id="inputName" name="cost"
                                            value="{{ $medicines->cost }}" title="يرجي ادخال تكلفة الدواء" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            value="{{ $medicines->price }}" title="يرجي ادخال سعر الدواء" required>
                                        </div>

                                        <div class="col">
                                            <label for="inputName" class="control-label">الصلاحية</label>
                                            <input type="date" class="form-control" id="inputName" name="exp"
                                            value="{{ $medicines->exp }}" title="يرجي ادخال تاريخ الصحلاحية" required>
                                        </div>
                                    </div>
