...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{ route('Doctors.index') }}">{{trans('doctors.Doctors')}}</a> </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/
               {{trans('doctors.create')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('Doctors.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="number_of_statement" type="text" autofocus required>
                                </div>
                            </div>
                            ...
                            <button type="submit"
                                    class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{ trans('Doctors.save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
