                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h5 class="invoice-title">فاتورة دواء </h5>
                            <div class="billed-from">
                                <h6>مستشفي الريان التخصصي</h6>
                                <p>201 المهندسين<br>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>التاريخ </span><span></span>{{ date('Y-m-d') }}</p>
                                <p class="invoice-info-row"><span> </span><span></span></p>
                                <br>
                                <p class="invoice-info-row"><span>رقم الفاتوره</span> <span>{{ Request::get('id') }}</span></p>
                                
                                <p class="invoice-info-row"><span>اسم المريض</span> <span></span>{{ Request::get('patient_id') }}</p>
                                <p class="invoice-info-row"><span>الطبيب</span> <span></span>{{ Request::get('doctor_id') }}</p>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody> 
                                   <tr>
                                    <td class="tx-right">باندول</td>
                                    <td class="tx-center">10</td>
                                    <td class="tx-center">2</td>
                                   </tr>
                                   <tr>
                                    <td class="tx-right">اموكلان</td>
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right" colspan="2"> {{number_format(Request::get('Total_before_discount'), 2)}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right" colspan="2"> {{Request::get('tax_value')}}</td>
                                </tr>
