...
use App\Http\Controllers\Auth\ParmacistController;
...
Route::middleware('guest')->group(function () {
    ...
    //====================================================================================================
    Route::post('/login/pharmacy', [ParmacistController::class, 'store'])->middleware('guest')->name('login.pharmacy');
    //====================================================================================================
...
//==============================================================================================
Route::post('/logout/laboratorie_employee', [LaboratorieEmployeeController::class, 'destroy'])->middleware('auth:laboratorie')->name('logout.laboratorie_employee');
//==============================================================================================
Route::post('/logout/patient', [PatientController::class, 'destroy'])->middleware('auth:patient')->name('logout.patient');

//==============================================================================================

Route::post('/logout/pharmacy', [ParmacistController::class, 'destroy'])->middleware('auth:pharmacy')->name('logout.pharmacy');
